...
// with a fixed step period defined by RESET_STEP_MICROSEC_X27
#define RESET_STEP_MICROSEC_X27 800
...
void SwitecX27::zero()
{
  ...
  for (unsigned int i=0;i<steps;i++) {
    stepDown();
    delayMicroseconds(RESET_STEP_MICROSEC_X27);
  }
  currentStep = 0;
  targetStep = 0;
  vel = 0;
